  ...
  return (
    ...
    >
      ...
      <main style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        >
          <div className="shimmer" style={{ position: "absolute", top: 0, left: 0, right: 0, height: "2px", borderRadius: "24px 24px 0 0" }} />
          <h2 style={{
            fontSize: "2rem",
            fontWeight: "700",
            marginBottom: "1.5rem",
          ...
          <p style={{ 
            ...
            A highly skilled Frontend Developer with experience in building scalable, responsive, and pixel-perfect web interfaces. I specialize in JavaScript, React.js, Redux, and TypeScript. I'm passionate about turning design into functional UI/UX with strong attention to performance and clean architecture.
          </p>
        </motion.section>
        ...
        >
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: "1.4rem", fontWeight: "600", color: "#3b82f6", marginBottom: "0.5rem" }}>
              Associate Software Developer
            </h3>
            <p style={{ color: "#10b981", fontSize: "1.1rem", fontWeight: "500" }}>
        ...
        >
          ...
          <div style={{ display: "grid", gap: "1rem", lineHeight: "1.8", fontSize: "1rem" }}>
            {[
              { label: "Frontend:", value: "HTML5, CSS3, Sass, Bootstrap, JavaScript, TypeScript" },
              { label: "Libraries:", value: "React.js, Redux, Redux-Thunk, Redux Toolkit" },
              { label: "Testing:", value: "Jest with React Testing Library" },
              { label: "Other Tools:", value: "GraphQL, Material UI, VS Code, Sublime" },
              { label: "Patterns:", value: "Singleton, Component Reusability, Modularization" },
              ...
              <div key={index} style={{ 
                ...
                <span style={{ fontWeight: "600", color: "#3b82f6" }}>{tech.label}</span>{" "}
            ...
            {[
              {
                ...
                institution: "Chadalawda Ramanamma Engineering College, Tirupati"
              },
              {
                degree: "Intermediate",
              ...
              <div key={index} style={{
                ...
                <h3 style={{ fontSize: "1.2rem", fontWeight: "600", color: "#8b5cf6", marginBottom: "0.5rem" }}>
                  {edu.degree}
                </h3>
        ...
        >
          ...
          >
            <div className="shimmer" style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, borderRadius: "50px" }} />
