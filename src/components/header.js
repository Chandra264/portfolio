...
export default function Header() {
  ...
  const linkBaseStyle = {
    color: "#f1f5f9", // soft gray-white text
    textDecoration: "none",
    fontSize: isMobile ? "0.875rem" : "1rem",
    fontWeight: "600",
    padding: isMobile ? "0.5rem 1.25rem" : "0.5rem 1.5rem",
    borderRadius: "10px",
    background: "rgba(255, 255, 255, 0.08)", // softer glassy effect
  ...
  return (
    <motion.header
      ...
      style={{
        ...
        background:
          "linear-gradient(135deg, rgba(17, 24, 39, 0.8), rgba(31, 41, 55, 0.8))", // Dark gray gradient
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <motion.h1
            ...
            style={{
              fontSize: "clamp(1.5rem, 4vw, 2.5rem)", // Fully responsive sizing
              fontWeight: "900",
              background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
              textShadow: "none", // Remove for gradient text
